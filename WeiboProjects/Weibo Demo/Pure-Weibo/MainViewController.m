...
- (void)_initViewController
{
    ...
    NSArray *tabNormalBackgroud = @[@"tabbar_home.png",@"tabbar_message_center.png",@"tabbar_discover.png",@"tabbar_profile.png"];
...
- (void)loadUnreadData
{
    ...
    NSString *requestURL = [WBWeiboTool URLAppendingAccessTokenWithQueryPath:URL_UNREAD_COUNT];
    NSMutableDictionary *params = [NSMutableDictionary dictionaryWithDictionary:@{@"uid": @([WBAccountTool account].uid)}];
